...
public class JoinGamePage extends BasicPage {
    ...
    public void initActionListener() {
        button.addActionListener(button->{
            //TODO 应该做一下输入校验的
            new Thread(()->
                    //new GamePage("五子棋",ipTextField.getText(),Integer.parseInt(portTextField.getText()))
                    SocketClient.runClient(ipTextField.getText(),Integer.parseInt(portTextField.getText()),Integer.parseInt(idTextField.getText())))
                    .start();
